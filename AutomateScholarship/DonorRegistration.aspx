<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonorRegistration.aspx.cs" Inherits="AutomateScholarship.DonorRegistration" %>
...
<body>
    ...
    <section class="w3l-workinghny-form">
        ...
        <div class="workinghny-form-grid">
            <div class="wrapper">
                <div class="logo">
                    <h1><a class="brand-logo" href="DonorRegistration.html">Donor Registration form</a></h1>
                ...
                <div class="workinghny-block-grid">
                    ...
                    <label for="exampleInputEmail1">
                        Select Donor Type</label>
                    <asp:DropDownList ID="ddlDonorType" runat="server" class="form-control">
                        <asp:ListItem>--Select--</asp:ListItem>
                        <asp:ListItem>Company</asp:ListItem>
                        <asp:ListItem>Individual</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Select Donor Type"
                        ControlToValidate="ddlDonorType" InitialValue="--Select--" ForeColor="Red" ValidationGroup="A"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">
        ...
        <div class="copyright text-center">
            <div class="wrapper">
                <p class="copy-footer-29">© 2023 Automate Scholarship System. All rights reserved | Design by Automate Scholarship System</p>
            </div>
        </div>
        <!-- //copyright-->
    </section>
